...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        File file4 = new File (in.nextLine ());//C:/Users/Андрей/Desktop/file1.txt
//        System.out.println ("Введите путь к файлу:");
...
//        File file5 = new File (in.nextLine ());
        TxtReader txtReader = new TxtReader (file4);
...
//        System.out.println (txtReader.countVirgule ());//задача5 количество запятых
    }
}
