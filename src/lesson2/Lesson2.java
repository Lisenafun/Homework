...
/*      Задача 2
        Создайте программу,
        выводящую на экран все неотрицательные элементы
...
/*        Задача 4
        ...
        int x = 5;
        if (x>1 & x % 2 > 0 & x % 3 > 0 ){
            System.out.println("Натуральное число " + x + " является простым");
        } else {
